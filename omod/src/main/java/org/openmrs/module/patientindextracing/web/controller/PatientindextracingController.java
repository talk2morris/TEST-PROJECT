 ...
 */
package org.openmrs.module.patientindextracing.web.controller;
 ...
 */
@Controller("${rootrootArtifactid}.PatientindextracingController")
@RequestMapping(value = "module/${rootArtifactid}/${rootArtifactid}.form")
public class PatientindextracingController {
